...
_lr_productions = [
  ...
  ('statement -> VAR ID ASSIGN NUMBER','statement',4,'p_statement_var','parser.py',41),
  ('statement -> ID ASSIGN expression','statement',3,'p_statement_assign','parser.py',45),
  ('statement -> ID LPAREN expression RPAREN ASSIGN expression','statement',6,'p_statement_assign','parser.py',46),
  ('statement -> FORWARD NUMBER','statement',2,'p_statement_forward','parser.py',53),
  ('statement -> VAR ID','statement',2,'p_statement_var_decl','parser.py',57),
  ('statement -> VAR ID LPAREN NUMBER RPAREN','statement',5,'p_statement_var_decl','parser.py',58),
  ('var_ref -> ID','var_ref',1,'p_var_ref','parser.py',67),
  ('var_ref -> ID LPAREN expression RPAREN','var_ref',4,'p_var_ref','parser.py',68),
  ...
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','parser.py',90),
  ('expression -> NUMBER','expression',1,'p_expression_number','parser.py',95),
  ('expression -> var_ref','expression',1,'p_expression_var','parser.py',99),
  ('statement -> IF condition DO statements DONE','statement',5,'p_statement_if','parser.py',104),
  ('statement -> IF condition DO statements DONE ELDEF DO statements DONE','statement',9,'p_statement_if','parser.py',105),
  ('statement -> IF condition DO statements DONE ELDEF DO statements DONE ELUND DO statements DONE','statement',13,'p_statement_if','parser.py',106),
  ('condition -> expression LT expression','condition',3,'p_condition','parser.py',115),
  ('condition -> expression GT expression','condition',3,'p_condition','parser.py',116),
  ('condition -> expression EQ expression','condition',3,'p_condition','parser.py',117),
  ('statement -> WHILE condition DO statements DONE','statement',5,'p_statement_while','parser.py',127),
  ('statement -> WHILE condition DO statements FINISH statements DONE','statement',7,'p_statement_while','parser.py',128),
  ('expression -> ID LPAREN expression RPAREN','expression',4,'p_expression_call','parser.py',136),
  ('statement -> RETURN','statement',1,'p_statement_return','parser.py',140),
